...
public class Matrix {
	...
	/** @info Augmented Matrix, Solution Matrix*/
	double A[][];
	int rows, cols, rank;

	/** @info 1. Unique, 2. Many, 3. No Solution*/
	double U[], V[][];	String W[];
	...
	/** @info Gauss Elimination: Echelon Form */
	...
	/** @info Checks if the given Row is a ZeroRow or not */
	...
	/** @info Consistency of System of Linear Equations */
	...
	/** @info Compute the Solution based on Rank */
